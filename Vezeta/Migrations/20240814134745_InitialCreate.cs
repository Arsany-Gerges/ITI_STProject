        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppointmentRequests_Doctors_DoctorId1",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppointmentRequests_Patients_PatientId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentRequests_DoctorId1",
                table: "AppointmentRequests",
                column: "DoctorId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentRequests_PatientId1",
                table: "AppointmentRequests",
                column: "PatientId1");
        }
